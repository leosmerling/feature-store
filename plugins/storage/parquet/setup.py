...
setuptools.setup(
    name="hopeit.parquet-storage",
    version=version['ENGINE_VERSION'],
    description="Hopeit Engine Parquet Storage Toolkit",
    license="Apache 2",
    ...
    packages=[
        "hopeit.parquet_storage",
        "hopeit.parquet_storage.events",
    ],
    include_package_data=True,
    package_data={
        "hopeit.parquet_storage": ["py.typed"],
        "hopeit.parquet_storage.events": ["py.typed"],
    },
    python_requires=">=3.7",
    install_requires=[
